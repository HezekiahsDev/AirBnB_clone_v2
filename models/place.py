#!/usr/bin/python3
""" Places module containing class place """
...
class Place(BaseModel, Base):
    ...
    if storage_type == "db":
        ...
        @property
        def amenities(self):
            """ amenities available in a place
        ...
        def amenities(self, obj):
            """Add amenity objects to an amenity id
            """
            if obj is not None:
